...
public class CustomCountryList extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("Values Countries", String.valueOf(countries.get(position)));
        vh.textViewCountry.setText(countries.get(position).countryName);
        vh.textViewId.setText("" + countries.get(position).id);
        vh.textViewPopulation.setText("" + countries.get(position).population);
